...
local script = UI["b"]
	script.Parent.MouseButton1Click:Connect(function()
		...
		game:GetService("StarterGui"):SetCore("SendNotification",{
			Title = "Notification", -- Required
			Text = "cool (also im not using the pastebin link since i know it could get deleted)", -- Required
		})
	end)
end
task.spawn(SCRIPT_b)
...
local script = UI["d"]
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		game:GetService("StarterGui"):SetCore("SendNotification",{
			Title = "Notification", -- Required
			Text = "this hub is in beta so it could cause some silly stuff to happen", -- Required
		})
	end)
end
task.spawn(SCRIPT_d)
...
local script = UI["f"]
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		game:GetService("StarterGui"):SetCore("SendNotification",{
			Title = "Notification", -- Required
			Text = "also i put the code in my github since yes", -- Required
		})
	end)
end
task.spawn(SCRIPT_f)
